...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      '@spinnaker/helm': path.join(__dirname, 'src'),
      'helm': path.join(__dirname, 'src')
    }
  },
  ...
  module: {
    rules: [
      ...
      },
      {
        ...
        exclude: exclusionPattern,
        use: [
          { loader: 'ngtemplate-loader?relativeTo=' + (path.resolve(__dirname)) + '&prefix=helm' },
          { loader: 'html-loader' },
        ]
      },
      {
